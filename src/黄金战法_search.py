...
for stock_code in df_all_code.code:
    ...
    try:
        ...
        if (index_up > 0 and index_down > 0 and index_up > index_down) : 
            print("%06d"%stock_code)
            ...
            # data_ma5_array.append(df_history.iloc[index+add_index].ma5)
            # data_ma24_array.append(df_history.iloc[index+add_index].ma24)
            # data_ma99_array.append(df_history.iloc[index+add_index].ma99)
