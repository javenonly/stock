...
df_all_code = pd.DataFrame(pd.read_csv(stock_data_path + var_date +'_L__n_output.csv', index_col=None))
#历史数据日期yyyymmdd文件夹
index_stock = 0
# ,code
#直接保存
out = open(stock_data_path + var_date + '_L__n_output_PM2.csv','a', newline='')
